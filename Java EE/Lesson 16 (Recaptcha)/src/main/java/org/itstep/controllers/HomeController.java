...
import org.itstep.dto.CaptchaResponseDto;
...
public class HomeController {
    ...
    public HomeController(UsersRepository usersRepos,
                          PersonalDataRepository personalDataRepos,
...
//        booksRepository.save(book5);
    ...
    public String registration(@RequestParam("g-recaptcha-response") String captchaResp) {
        String queryUrl = String.format(captchaUrl + "?secret=%s&response=%s", captchaSecret, captchaResp);
        CaptchaResponseDto resp = restTemplate.postForObject(queryUrl, Collections.emptyList(), CaptchaResponseDto.class);
